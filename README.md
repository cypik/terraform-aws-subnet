...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_database-labels"></a> [database-labels](#module\_database-labels) | cypik/labels/aws | 1.0.2 |
| <a name="module_private-labels"></a> [private-labels](#module\_private-labels) | cypik/labels/aws | 1.0.2 |
| <a name="module_public-labels"></a> [public-labels](#module\_public-labels) | cypik/labels/aws | 1.0.2 |
...
| <a name="output_database_subnet_arn"></a> [database\_subnet\_arn](#output\_database\_subnet\_arn) | n/a |
...
| <a name="output_database_subnet_ipv6_cidr_block_association_id"></a> [database\_subnet\_ipv6\_cidr\_block\_association\_id](#output\_database\_subnet\_ipv6\_cidr\_block\_association\_id) | n/a |
| <a name="output_database_subnet_owner_id"></a> [database\_subnet\_owner\_id](#output\_database\_subnet\_owner\_id) | n/a |
| <a name="output_database_subnet_tags_all"></a> [database\_subnet\_tags\_all](#output\_database\_subnet\_tags\_all) | n/a |
...
| <a name="output_nat_gateway_subnet_id"></a> [nat\_gateway\_subnet\_id](#output\_nat\_gateway\_subnet\_id) | n/a |
...
| <a name="output_private_subnet_owner_id"></a> [private\_subnet\_owner\_id](#output\_private\_subnet\_owner\_id) | n/a |
| <a name="output_private_subnet_tags_all"></a> [private\_subnet\_tags\_all](#output\_private\_subnet\_tags\_all) | n/a |
| <a name="output_private_subnet_vpc_id"></a> [private\_subnet\_vpc\_id](#output\_private\_subnet\_vpc\_id) | n/a |
...
| <a name="output_public_private_subnet_arn"></a> [public\_private\_subnet\_arn](#output\_public\_private\_subnet\_arn) | n/a |
| <a name="output_public_private_subnet_id"></a> [public\_private\_subnet\_id](#output\_public\_private\_subnet\_id) | n/a |
| <a name="output_public_private_subnet_ipv6_cidr_block_association_id"></a> [public\_private\_subnet\_ipv6\_cidr\_block\_association\_id](#output\_public\_private\_subnet\_ipv6\_cidr\_block\_association\_id) | n/a |
| <a name="output_public_private_subnet_owner_id"></a> [public\_private\_subnet\_owner\_id](#output\_public\_private\_subnet\_owner\_id) | n/a |
| <a name="output_public_private_subnet_tags_all"></a> [public\_private\_subnet\_tags\_all](#output\_public\_private\_subnet\_tags\_all) | n/a |
...
| <a name="output_public_subnet_ipv6_cidr_block_association_id"></a> [public\_subnet\_ipv6\_cidr\_block\_association\_id](#output\_public\_subnet\_ipv6\_cidr\_block\_association\_id) | n/a |
| <a name="output_public_subnet_owner_id"></a> [public\_subnet\_owner\_id](#output\_public\_subnet\_owner\_id) | n/a |
| <a name="output_public_subnet_tags_all"></a> [public\_subnet\_tags\_all](#output\_public\_subnet\_tags\_all) | n/a |
| <a name="output_public_tags"></a> [public\_tags](#output\_public\_tags) | A mapping of public tags to assign to the resource. |
| <a name="output_route_table_vpc_id"></a> [route\_table\_vpc\_id](#output\_route\_table\_vpc\_id) | n/a |
| <a name="output_var_public_subnet_ids"></a> [var\_public\_subnet\_ids](#output\_var\_public\_subnet\_ids) | n/a |
<!-- END_TF_DOCS -->