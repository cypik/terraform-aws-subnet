...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_database-labels"></a> [database-labels](#module\_database-labels) | cypik/labels/aws | 1.0.1 |
| <a name="module_private-labels"></a> [private-labels](#module\_private-labels) | cypik/labels/aws | 1.0.1 |
| <a name="module_public-labels"></a> [public-labels](#module\_public-labels) | cypik/labels/aws | 1.0.1 |
